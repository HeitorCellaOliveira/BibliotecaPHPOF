...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24-Ago-2023 às 01:03
...
(7, 'Heitor Cella Oliveira', '3º EM', '(47) 9 9151-2930', 'Rua Germano Bastos, 345', 1234567890, 0);
...
DROP TABLE IF EXISTS `horaleitura`;
CREATE TABLE IF NOT EXISTS `horaleitura` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nome` varchar(140) NOT NULL,
  `turma` varchar(140) NOT NULL,
  `nomeLivro` varchar(140) NOT NULL,
  `atualPag` int NOT NULL,
