...
<?php
    ...
    xhttp.open("GET", "clubeLivroPesquisar.php?nomePesquisado=" + str, true);
    xhttp.send();
    }
    </script>';

    echo "<form method='post' action='clubeCadastrar.php'>
    ...
    while ($row = mysqli_fetch_array($resultado)) {
        ...
        echo "<td><form method='post' action='clubeAtualizar.php'>
