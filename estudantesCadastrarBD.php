...
if ($conexao->connect_errno) {
    ...
    $cadastrarAluno = 'INSERT INTO `biblioteca`.`cadastroalunos`(`nome`, `endereco`, `telefone`, `turma`, `nMatricula`, `qtdEmprestimo`)
            VALUES ("' . $nome . '", "' . $endereco . '", "' . $telefone . '", "' . $turma . '", "'. $nMatricula . '", "0");';
