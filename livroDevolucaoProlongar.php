...
<div class="center-container">
 ...
 <h1 style="font-family: 'Bebas Neue', sans-serif; justify-content:center; align-items:center; font-size:50px;">Prolongar Devolução</h1>
<br><br>
<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    # Consulta para prolongar a data de devolução e aumentar a quantidade de empréstimos
    $prolongar_sql = "
        UPDATE emprestimos 
        SET dataDevolucao = DATE_ADD(dataDevolucao, INTERVAL 7 DAY), qtdEmprestimo = qtdEmprestimo + 1 
