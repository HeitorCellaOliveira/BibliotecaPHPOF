...
<div class="center-container">
 ...
 <h1 style="font-family: 'Bebas Neue', sans-serif; justify-content:center; align-items:center; font-size:50px;">Cadastro de Turmas</h1>
<br><br>

<form method="post" action="turmasCadastrarBD.php" id="cadastro" name="cadastro">
                    <label for="nome" class="custom-search-txt">Nº da Turma:</label><br>
                    <input type="text" id="nome" name="nome" class="custom-search-txt2" placeholder="Digite o número da turma" required>
                    <br>
                    <label for="turno" class="custom-search-txt">Turno:</label>
                    <input type="text" id="turno" name="turno" class="custom-search-txt2" placeholder="Digite matutino ou vespertino" required>
                    <br>
                    <label for="num_alunos" class="custom-search-txt">Quantidade de Alunos:</label>
                    <input type="text" id="num_alunos" name="num_alunos" class="custom-search-txt2" placeholder="Digite a quantidade máxima" required>
                    <br> <br>
                    <input type="submit" value="Cadastrar" class="custom-search-btn">
</form>
